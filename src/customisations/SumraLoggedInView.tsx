...
import CallMediaHandler from 'matrix-react-sdk/src/CallMediaHandler';
...
import TagOrderActions from 'matrix-react-sdk/src/actions/TagOrderActions';
...
import CallContainer from 'matrix-react-sdk/src/components/views/voip/CallContainer';
 ...
 */
class SumraLoggedInView extends React.Component<IProps, IState> {
...
const AudioFeedArrayForCall = sdk.getComponent("views.voip.AudioFeedArrayForCall")
            return (
        ...
        const ResizeHandle = sdk.getComponent("views.elements.ResizeHandle")
...
export default SumraLoggedInView;
